...
- **Package:** `com.whispertype.android` (currently `versionName 1.2.5`, `versionCode 71`)
- **Branch:** `main`
- **APK:** `app/build/outputs/apk/release/app-release.apk`
- **GitHub download:** https://github.com/chaosmanage/WhisperType-Android/releases/download/v1.2.5/app-release.apk
